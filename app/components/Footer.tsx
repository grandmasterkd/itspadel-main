  ...
  return (
    <footer className="font-inter mt-24">
      ...
      >
        {/* First Container */}
        <motion.div
          className="px-8 md:px-16 lg:px-32 py-8 border-t border-b border-gray-200"
        ...
        {/* Second Container */}
        <motion.div
          className="px-8 md:px-16 lg:px-32 py-20 border-b border-gray-200"
          variants={itemVariants}
        >
        ...
        {/* Third Container */}
        <motion.div
          className="px-8 md:px-16 lg:px-32 py-10"
          variants={itemVariants}
        >
