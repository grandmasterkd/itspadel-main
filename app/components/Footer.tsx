...
const Footer = () => {
  ...
  return (
    <footer className="font-inter mt-24">
      {/* First Container */}
      <div className="px-8 md:px-16 lg:px-32 py-8 border-t border-b border-gray-200 animate-fade-in-0">
      ...
      {/* Second Container */}
      <div className="px-8 md:px-16 lg:px-32 py-20 border-b border-gray-200 animate-fade-in-1">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-0 py-3 border-b border-gray-300 bg-transparent tracking-tighter text-base"
              />
